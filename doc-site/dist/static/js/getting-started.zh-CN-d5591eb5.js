import{_ as a,r as o,c as e,w as p,o as c,a as n,b as s}from"./index-2ff0e9c4.js";const l={name:"DocGettingStarted"},u=n("article",{class:"bs-vue-doc-article getting-started-article"},[n("h1",null,"快速上手"),n("p",null,"本节将介绍如何在项目中使用 Bootstrap Vue。"),n("h2",null,"引入 Bootstrap Vue"),n("h3",null,"安装"),n("ol",null,[n("li",null,[s("使用"),n("code",null,"npm"),s("安装")])]),n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"npm"),s(),n("span",{class:"token function"},"install"),s(" bs-vue "),n("span",{class:"token parameter variable"},"-S"),s(`
...
`),n("span",{class:"token comment"},"// 导入bs-vue"),s(`
`),n("span",{class:"token keyword"},"import"),s(" BsVue "),n("span",{class:"token keyword"},"from"),s(),n("span",{class:"token string"},"'bs-vue'"),n("span",{class:"token punctuation"},";"),s(`
`),n("span",{class:"token comment"},"// 导入bs-vue组件样式"),s(`
`),n("span",{class:"token comment"},"// import 'bs-vue/es/components/index.js'; // 导入的是.scss文件"),s(`
`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/components/css.js'"),n("span",{class:"token punctuation"},";"),s(),n("span",{class:"token comment"},"// 导入的是.css文件"),s(`
`),n("span",{class:"token comment"},"// 导入除bootstrap组件样式外的其他样式（如果您需要的话），如栅格系统、导航栏、卡片、布局等"),s(`
`),n("span",{class:"token comment"},"// import 'bs-vue/es/styles/bootstrap-other.scss';"),s(`
`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/styles/bootstrap-other.css'"),n("span",{class:"token punctuation"},";"),s(`
...
app`),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"use"),n("span",{class:"token punctuation"},"("),s("BsVue"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"mount"),n("span",{class:"token punctuation"},"("),n("span",{class:"token string"},"'#app'"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),s(`
...
`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token punctuation"},"{"),s(" BsButton"),n("span",{class:"token punctuation"},","),s(" BsInput"),n("span",{class:"token punctuation"},","),s(" BsDropdown"),n("span",{class:"token punctuation"},","),s(" BsMessage "),n("span",{class:"token punctuation"},"}"),s(),n("span",{class:"token keyword"},"from"),s(),n("span",{class:"token string"},"'bs-vue'"),n("span",{class:"token punctuation"},";"),s(`
 ...
 */`),s(`
`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/compoents/style.js'"),n("span",{class:"token punctuation"},";"),s(),n("span",{class:"token comment"},"// 导入的是.scss文件"),s(`
`),n("span",{class:"token comment"},"// import 'bs-vue/es/compoents/css.js'; // 导入的是.css文件"),s(`
...
`),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("script")]),n("span",{class:"token punctuation"},">")]),n("span",{class:"token script"},[n("span",{class:"token language-javascript"},[s(`
  `),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token punctuation"},"{"),s(" BsButton"),n("span",{class:"token punctuation"},","),s(" BsDropdown"),n("span",{class:"token punctuation"},","),s(" BsDropdownItem "),n("span",{class:"token punctuation"},"}"),s(),n("span",{class:"token keyword"},"from"),s(),n("span",{class:"token string"},"'bs-vue'"),n("span",{class:"token punctuation"},";"),s(`
  `),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/compoents/bs-button/style'"),n("span",{class:"token punctuation"},";"),s(),n("span",{class:"token comment"},"// 导入的是.scss文件"),s(`
  `),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/compoents/bs-dropdown/style'"),n("span",{class:"token punctuation"},";"),s(),n("span",{class:"token comment"},"// 导入的是.scss文件"),s(`
...
`)])]),n("h2",null,"浏览器引入"),n("p",null,[s("在浏览器中使用"),n("code",null,"script"),s("和"),n("code",null,"link"),s("标签直接引入文件，并使用全局变量"),n("code",null,"BsVue")]),n("p",null,[s("在 npm 发布包内的 "),n("code",null,"bd-vue/dist"),s(" 目录下有 "),n("code",null,"bs-vue.js"),s("、"),n("code",null,"bs-vue.css"),s("、"),n("code",null,"bootstrap-other.css"),s("文件，你可以手动的引入它们")]),n("pre",{class:"language-html"},[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("link")]),s(),n("span",{class:"token attr-name"},"rel"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("stylesheet"),n("span",{class:"token punctuation"},'"')]),s(),n("span",{class:"token attr-name"},"href"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("bs-vue.css"),n("span",{class:"token punctuation"},'"')]),n("span",{class:"token punctuation"},">")]),s(`
`),n("span",{class:"token comment"},"<!--导入除bootstrap组件样式外的其他样式（如果您需要的话），如栅格系统、导航栏、卡片、布局等-->"),s(`
...
`),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("script")]),s(),n("span",{class:"token attr-name"},"src"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("bs-vue.js"),n("span",{class:"token punctuation"},'"')]),n("span",{class:"token punctuation"},">")]),n("span",{class:"token script"}),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),s("script")]),n("span",{class:"token punctuation"},">")]),s(`
`)])]),n("h2",null,"按需加载"),n("h3",null,"手动按需导入"),n("p",null,"如果您未使用任何按需加载插件，您可以通过手动导入的方式来按需加载组件："),n("pre",{class:"language-javascript"},[n("code",null,[n("span",{class:"token keyword"},"import"),s(" BsButton "),n("span",{class:"token keyword"},"from"),s(),n("span",{class:"token string"},"'bs-vue/es/components/bs-button'"),n("span",{class:"token punctuation"},";"),s(`
`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/components/bs-button/style'"),n("span",{class:"token punctuation"},";"),s(),n("span",{class:"token comment"},"// 导入的是.scss文件"),s(`
`),n("span",{class:"token comment"},"// 或 import 'bs-vue/es/components/bs-button/style/css'; 导入的是.css文件"),s(`

`),n("span",{class:"token keyword"},"import"),s(" BsForm "),n("span",{class:"token keyword"},"from"),s(),n("span",{class:"token string"},"'bs-vue/es/components/bs-form'"),n("span",{class:"token punctuation"},";"),s(`
`),n("span",{class:"token keyword"},"import"),s(" BsFormItem "),n("span",{class:"token keyword"},"from"),s(),n("span",{class:"token string"},"'bs-vue/es/components/bs-form/widgets/BsofromItem'"),n("span",{class:"token punctuation"},";"),s(`
`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/components/bs-form/style'"),n("span",{class:"token punctuation"},";"),s(),n("span",{class:"token comment"},"// 导入的是.scss文件"),s(`
`),n("span",{class:"token comment"},"// 或 import 'bs-vue/es/components/bs-form/style/css'; 导入的是.css文件"),s(`
...
`),n("span",{class:"token keyword"},"export"),s(),n("span",{class:"token keyword"},"interface"),s(),n("span",{class:"token class-name"},"BsVueResolverOptions"),s(),n("span",{class:"token punctuation"},"{"),s(`
...
`),n("span",{class:"token keyword"},"function"),s(),n("span",{class:"token function"},"getSideEffects"),n("span",{class:"token punctuation"},"("),n("span",{class:"token parameter"},[n("span",{class:"token literal-property property"},"compName"),n("span",{class:"token operator"},":"),s(" string"),n("span",{class:"token punctuation"},","),s(),n("span",{class:"token literal-property property"},"options"),n("span",{class:"token operator"},":"),s(" BsVueResolverOptions")]),n("span",{class:"token punctuation"},")"),n("span",{class:"token operator"},":"),s(" SideEffectsInfo "),n("span",{class:"token punctuation"},"{"),s(`
  ...
  `),n("span",{class:"token keyword"},"const"),s(" packageName "),n("span",{class:"token operator"},"="),s(" options"),n("span",{class:"token operator"},"?."),s("packageName "),n("span",{class:"token operator"},"||"),s(),n("span",{class:"token string"},"'bs-vue'"),n("span",{class:"token punctuation"},";"),s(`
 ...
 * Resolver for BsVue
 */`),s(`
`),n("span",{class:"token keyword"},"export"),s(),n("span",{class:"token keyword"},"function"),s(),n("span",{class:"token function"},"BsVueResolver"),n("span",{class:"token punctuation"},"("),n("span",{class:"token parameter"},[n("span",{class:"token literal-property property"},"options"),n("span",{class:"token operator"},":"),s(" BsVueResolverOptions "),n("span",{class:"token operator"},"="),s(),n("span",{class:"token punctuation"},"{"),n("span",{class:"token punctuation"},"}")]),n("span",{class:"token punctuation"},")"),n("span",{class:"token operator"},":"),s(" ComponentResolver "),n("span",{class:"token punctuation"},"{"),s(`
  `),n("span",{class:"token keyword"},"return"),s(),n("span",{class:"token punctuation"},"{"),s(`
    ...
    `),n("span",{class:"token function-variable function"},"resolve"),n("span",{class:"token operator"},":"),s(),n("span",{class:"token punctuation"},"("),n("span",{class:"token parameter"},[n("span",{class:"token literal-property property"},"name"),n("span",{class:"token operator"},":"),s(" string")]),n("span",{class:"token punctuation"},")"),s(),n("span",{class:"token operator"},"=>"),s(),n("span",{class:"token punctuation"},"{"),s(`
      `),n("span",{class:"token keyword"},"const"),s(),n("span",{class:"token punctuation"},"{"),s(" cjs "),n("span",{class:"token operator"},"="),s(),n("span",{class:"token boolean"},"false"),n("span",{class:"token punctuation"},","),s(" packageName "),n("span",{class:"token operator"},"="),s(),n("span",{class:"token string"},"'bs-vue'"),s(),n("span",{class:"token punctuation"},"}"),s(),n("span",{class:"token operator"},"="),s(" options"),n("span",{class:"token punctuation"},";"),s(`
...
`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token punctuation"},"{"),s(" BsVueResolver "),n("span",{class:"token punctuation"},"}"),s(),n("span",{class:"token keyword"},"from"),s(),n("span",{class:"token string"},"'./unplugin-vue-components-resolver'"),n("span",{class:"token punctuation"},";"),s(`
  ...
  `),n("span",{class:"token literal-property property"},"plugins"),n("span",{class:"token operator"},":"),s(),n("span",{class:"token punctuation"},"["),s(`
    ...
    `),n("span",{class:"token function"},"Components"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),s(`
      ...
      `),n("span",{class:"token literal-property property"},"resolvers"),n("span",{class:"token operator"},":"),s(),n("span",{class:"token punctuation"},"["),s(`
        `),n("span",{class:"token function"},"BsVueResolver"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),s(`
          ...
          `),n("span",{class:"token comment"},"// packageName: string, // 组件库名称，默认为：bs-vue"),s(`
        `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),s(`
      `),n("span",{class:"token punctuation"},"]"),s(`
    `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),s(`
  `),n("span",{class:"token punctuation"},"]"),s(`
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),s(`
`)])]),n("ol",{start:"3"},[n("li",null,"此插件无法处理非组件模块，如BsMessage、BsToast、BsMessageBox，这种组件需要手动加载：")]),n("pre",{class:"language-javascript"},[n("code",null,[n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token punctuation"},"{"),s(" BsMessage"),n("span",{class:"token punctuation"},","),s(" BsToast"),n("span",{class:"token punctuation"},","),s(" BsMessageBox "),n("span",{class:"token punctuation"},"}"),s(),n("span",{class:"token keyword"},"from"),s(),n("span",{class:"token string"},"'bs-vue'"),n("span",{class:"token punctuation"},";"),s(`

`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/components/bs-message/style'"),n("span",{class:"token punctuation"},";"),s(),n("span",{class:"token comment"},"// 或 import 'bs-vue/es/components/bs-message/style/css';"),s(`
`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/components/bs-message-box/style'"),n("span",{class:"token punctuation"},";"),s(`
`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/components/bs-toast/style'"),n("span",{class:"token punctuation"},";"),s(`
`)])])],-1);function k(r,i,m,g,d,y){const t=o("bs-vue-doc");return c(),e(t,null,{default:p(()=>[u]),_:1})}const f=a(l,[["render",k]]);export{f as default};
