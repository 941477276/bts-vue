import{_ as a,r as o,c as e,w as p,o as c,a as n,b as s}from"./index-2ff0e9c4.js";const l={name:"DocGettingStarted"},u=n("article",{class:"bs-vue-doc-article getting-started-article"},[n("h1",null,"Get started quickly"),n("p",null,"This section describes how to use Bootstrap Vue in your project."),n("h2",null,"Import Bootstrap Vue"),n("h3",null,"Install"),n("ol",null,[n("li",null,[s("Install using "),n("code",null,"npm")])]),n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"npm"),s(),n("span",{class:"token function"},"install"),s(" bs-vue "),n("span",{class:"token parameter variable"},"-S"),s(`
...
`),n("span",{class:"token comment"},"// import bs-vue"),s(`
...
`),n("span",{class:"token comment"},"// import bs-vue component style"),s(`
`),n("span",{class:"token comment"},"// import 'bs-vue/es/components/index.js'; // import is .scss file"),s(`
`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/components/css.js'"),n("span",{class:"token punctuation"},";"),s(),n("span",{class:"token comment"},"// import is .css file"),s(`
...
`),n("span",{class:"token comment"},`/** Import component style method 2: import all component styles at once
  ...
  */`),s(`
`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/components/style.js'"),n("span",{class:"token punctuation"},";"),s(),n("span",{class:"token comment"},"// import is .scss file"),s(`
`),n("span",{class:"token comment"},"// import 'bs-vue/es/components/css.js'; // imports the .css file"),s(`
...
`),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("script")]),n("span",{class:"token punctuation"},">")]),n("span",{class:"token script"},[n("span",{class:"token language-javascript"},[s(`
   ...
   `),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/components/bs-button/style'"),n("span",{class:"token punctuation"},";"),s(),n("span",{class:"token comment"},"// import is .scss file"),s(`
   `),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/components/bs-dropdown/style'"),n("span",{class:"token punctuation"},";"),s(),n("span",{class:"token comment"},"// import is .scss file"),s(`
...
`)])]),n("h2",null,"Browser introduction"),n("p",null,[s("Use the "),n("code",null,"script"),s(" and "),n("code",null,"link"),s(" tags in the browser to directly import the file, and use the global variable "),n("code",null,"BsVue")]),n("p",null,[s("There are "),n("code",null,"bs-vue.js"),s(", "),n("code",null,"bs-vue.css"),s(", "),n("code",null,"bootstrap-other.css"),s(" files in the "),n("code",null,"bd-vue/dist"),s(" directory in the npm release package, you can import them manually")]),n("pre",{class:"language-html"},[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("link")]),s(),n("span",{class:"token attr-name"},"rel"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("stylesheet"),n("span",{class:"token punctuation"},'"')]),s(),n("span",{class:"token attr-name"},"href"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("bs-vue.css"),n("span",{class:"token punctuation"},'"')]),n("span",{class:"token punctuation"},">")]),s(`
...
`)])]),n("h2",null,"Load on demand"),n("h3",null,"Manual import on demand"),n("p",null,"If you are not using any on-demand plugins, you can manually import components on-demand:"),n("pre",{class:"language-javascript"},[n("code",null,[n("span",{class:"token keyword"},"import"),s(" BsButton "),n("span",{class:"token keyword"},"from"),s(),n("span",{class:"token string"},"'bs-vue/es/components/bs-button'"),n("span",{class:"token punctuation"},";"),s(`
`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/components/bs-button/style'"),n("span",{class:"token punctuation"},";"),s(),n("span",{class:"token comment"},"// import is .scss file"),s(`
`),n("span",{class:"token comment"},"// or import 'bs-vue/es/components/bs-button/style/css'; the imported .css file"),s(`
...
`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/components/bs-form/style'"),n("span",{class:"token punctuation"},";"),s(),n("span",{class:"token comment"},"// import is .scss file"),s(`
`),n("span",{class:"token comment"},"// or import 'bs-vue/es/components/bs-form/style/css'; the imported .css file"),s(`
     ...
     `),n("span",{class:"token function"},"Components"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),s(`
       ...
       `),n("span",{class:"token literal-property property"},"resolvers"),n("span",{class:"token operator"},":"),s(),n("span",{class:"token punctuation"},"["),s(`
         `),n("span",{class:"token function"},"BsVueResolver"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),s(`
           ...
           `),n("span",{class:"token comment"},"// packageName: string, // component library name, the default is: bs-vue"),s(`
         `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),s(`
       `),n("span",{class:"token punctuation"},"]"),s(`
     `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),s(`
   `),n("span",{class:"token punctuation"},"]"),s(`
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),s(`
`)])]),n("ol",{start:"3"},[n("li",null,"This plugin cannot handle non-component modules, such as BsMessage, BsToast, BsMessageBox, such components need to be loaded manually:")]),n("pre",{class:"language-javascript"},[n("code",null,[n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token punctuation"},"{"),s(" BsMessage"),n("span",{class:"token punctuation"},","),s(" BsToast"),n("span",{class:"token punctuation"},","),s(" BsMessageBox "),n("span",{class:"token punctuation"},"}"),s(),n("span",{class:"token keyword"},"from"),s(),n("span",{class:"token string"},"'bs-vue'"),n("span",{class:"token punctuation"},";"),s(`

`),n("span",{class:"token keyword"},"import"),s(),n("span",{class:"token string"},"'bs-vue/es/components/bs-message/style'"),n("span",{class:"token punctuation"},";"),s(),n("span",{class:"token comment"},"// or import 'bs-vue/es/components/bs-message/style/css';"),s(`
...
`)])])],-1);function i(r,k,m,d,y,g){const t=o("bs-vue-doc");return c(),e(t,null,{default:p(()=>[u]),_:1})}const b=a(l,[["render",i]]);export{b as default};
