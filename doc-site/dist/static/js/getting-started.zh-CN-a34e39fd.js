...
`),n("span",{class:"token keyword"},"import"),s(" BsVue "),n("span",{class:"token keyword"},"from"),s(),n("span",{class:"token string"},"'bts-vue'"),n("span",{class:"token punctuation"},";"),s(`
...
`)])])],-1);function k(r,i,m,g,d,y){const t=o("bts-vue-doc");return c(),e(t,null,{default:p(()=>[u]),_:1})}const f=a(l,[["render",k]]);export{f as default};
