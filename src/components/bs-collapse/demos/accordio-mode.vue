...
<template>
  <div>
    <bs-collapse v-model="activeNames" accordion>
      ...
      <BsCollapseItem title="Angular(disabled)" disabled>Angular</BsCollapseItem>
      <BsCollapseItem title="Vue">
